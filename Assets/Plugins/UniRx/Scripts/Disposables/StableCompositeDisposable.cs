    ...
    public abstract class StableCompositeDisposable : ICancelable
    {
        ...
        class Binary : StableCompositeDisposable
        {
            int disposedCallCount = -1;
             volatile IDisposable _disposable1;
             volatile IDisposable _disposable2;
        ...
        class Trinary : StableCompositeDisposable
        {
            int disposedCallCount = -1;
             volatile IDisposable _disposable1;
             volatile IDisposable _disposable2;
             volatile IDisposable _disposable3;
        ...
        class Quaternary : StableCompositeDisposable
        {
            int disposedCallCount = -1;
             ...
             volatile IDisposable _disposable2;
             volatile IDisposable _disposable3;
             volatile IDisposable _disposable4;
        ...
        {
            int disposedCallCount = -1;
             volatile List<IDisposable> _disposables;
        ...
        {
            int disposedCallCount = -1;
             volatile IDisposable[] _disposables;
