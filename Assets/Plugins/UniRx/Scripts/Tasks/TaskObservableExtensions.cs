...
namespace UniRx
{
    ...
    public static class TaskObservableExtensions
    {
        ...
        public static IObservable<Unit> ToObservable(this Task task, IScheduler scheduler)
        {
         ...
         static IObservable<Unit> ToObservableImpl(Task task, IScheduler scheduler)
        {
         ...
         static IObservable<Unit> ToObservableSlow(Task task, IScheduler scheduler)
        {
         ...
         static void ToObservableDone(Task task, IObserver<Unit> subject)
        {
            switch (task.Status)
            {
                case TaskStatus.RanToCompletion:
        ...
        public static IObservable<TResult> ToObservable<TResult>(this Task<TResult> task, IScheduler scheduler)
        {
         ...
         static IObservable<TResult> ToObservableImpl<TResult>(Task<TResult> task, IScheduler scheduler)
        {
         ...
         static IObservable<TResult> ToObservableSlow<TResult>(Task<TResult> task, IScheduler scheduler)
        {
         ...
         static void ToObservableDone<TResult>(Task<TResult> task, IObserver<TResult> subject)
        {
         ...
         static TaskContinuationOptions GetTaskContinuationOptions(IScheduler scheduler)
        {
         ...
         static IObservable<TResult> ToObservableResult<TResult>(AsyncSubject<TResult> subject, IScheduler scheduler)
        {
            if (scheduler != null)
            {
